...
for example if you have downloaded `jocds-cli-0.2.0.jar` you should be able to start it using

```
java -jar jocds-cli-0.2.0.jar
```
...
jocds : The Java Open Contracting Data Standard Validator 0.2.0 : Copyright (c) 2017 Development Gateway, Inc
Usage:
...
```
java -jar jocds-cli-0.2.0.jar -operation=validate -schema-type=release-package -file=ocds-213czf-000-00001-02-tender.json
jocds : The Java Open Contracting Data Standard Validator 0.2.0 : Copyright (c) 2017 Development Gateway, Inc
...
```
java -jar jocds-cli-0.2.0.jar -operation=validate -version=1.0.2 -schema-type=release-package -file=ocds-213czf-000-00001-02-tender.json
```
...
Notice jocds-cli-0.2.0 supports all OCDS versions released up to 1.1.1.
...
```
java -jar jocds-cli-0.2.0.jar -operation=validate -schema-type=release-package -extensions=https://raw.githubusercontent.com/open-contracting/ocds_bid_extension/v1.1/extension.json,ocds_lots_extension/v1.1
